...
var (
	...
	authorsFileHeader = "# This is the official list of go-TITprotocol authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-TITprotocol Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-TITprotocol"
	}
	if startOfSentence {
		return "The go-TITprotocol library"
	}
	return "the go-TITprotocol library"
}
