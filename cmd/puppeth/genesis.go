// Copyright 2017 The go-TITprotocol Authors
...
import (
	...
	math2 "github.com/TITprotocol/go-TITprotocol/common/math"
...
// newAlethGenesisSpec converts a go-TITprotocol genesis block into a Aleth-specific
// chain specification format.
func newAlethGenesisSpec(network string, genesis *core.Genesis) (*alethGenesisSpec, error) {
	// Only ethash is currently supported between go-TITprotocol and aleth
...
// newParityChainSpec converts a go-TITprotocol genesis block into a Parity specific
// chain specification format.
func newParityChainSpec(network string, genesis *core.Genesis, bootnodes []string) (*parityChainSpec, error) {
	// Only ethash is currently supported between go-TITprotocol and Parity
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
...
// newPyEthereumGenesisSpec converts a go-TITprotocol genesis block into a Parity specific
// chain specification format.
func newPyEthereumGenesisSpec(network string, genesis *core.Genesis) (*pyEthereumGenesisSpec, error) {
	// Only ethash is currently supported between go-TITprotocol and pyethereum
	if genesis.Config.Ethash == nil {
		return nil, errors.New("unsupported consensus engine")
	}
