...
//
// Detailed usage document and tutorial available on the go-TITprotocol Wiki page:
// https://github.com/TITprotocol/go-TITprotocol/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
...
import (
	...
	"github.com/TITprotocol/go-TITprotocol/accounts/abi"
)
